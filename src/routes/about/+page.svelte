<!-- About Section -->
<section class="about-section style-padding section-padding fix">
	<div class="bg-shape">
	...
	<div class="container">
		<div class="section-title ml-200">
		...
		<div class="row">
			<div class="col-lg-5">
				<div class="about-image-33 img-custom-anim-left">
					<img src="/assets/img/about/06.jpg" alt="img">
				</div>
			</div>
			<div class="col-lg-7">
				<div class="about-image-33 img-custom-anim-right">
					<img src="/assets/img/about/07.jpg" alt="img">
				</div>
			</div>
		</div>
		<div class="about-wrapper mt-4">
			<ul class="nav">
				<li class="nav-item wow fadeInUp" data-wow-delay=".3s">
					<a href="#Mission" data-bs-toggle="tab" class="nav-link">Our Mission</a>
				</li>
				<li class="nav-item wow fadeInUp" data-wow-delay=".5s">
					<a href="#Vision" data-bs-toggle="tab" class="nav-link active">Our Vision</a>
				</li>
				<li class="nav-item wow fadeInUp" data-wow-delay=".5s">
					<a href="#Feature" data-bs-toggle="tab" class="nav-link">Key Feature</a>
				</li>
			</ul>
			<div class="tab-content">
				<div id="Mission" class="tab-pane fade">
					<div class="about-items">
						<div class="about-content">
							...
							<a href="/about" class="theme-btn">explore now <i class="fa-sharp fa-regular fa-arrow-up-right"></i></a>
						</div>
				...
				<div id="Vision" class="tab-pane fade show active">
					<div class="about-items">
						<div class="about-content">
							...
							<a href="/about" class="theme-btn wow fadeInUp" data-wow-delay=".3s">explore now <i class="fa-sharp fa-regular fa-arrow-up-right"></i></a>
						</div>
...
<section class="team-section section-padding section-bg fix">
	<div class="container">
		<div class="section-title text-center">
			<h6 class="wow fadeInUp">
				<img src="/assets/img/star.png" alt="img"> Our Team Member
			</h6>
			<h2 class="wow fadeInUp" data-wow-delay=".3s">
				Meet the brilliant minds <br>
				<span>behind our <b>team</b></span>
			</h2>
		</div>
		<div class="row">
			<div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
				<div class="team-card-items">
					...
					<div class="team-content text-center">
						<h4><a href="/team">Rosa Compton</a></h4>
						<p>Creative Designer</p>
						<div class="social-icon d-flex align-items-center justify-content-center">
							<a href="#0" aria-label="Discord"><i class="fa-brands fa-discord"></i></a>
			...
			<div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
				<div class="team-card-items">
					...
					<div class="team-content text-center">
						<h4><a href="/team">Clifford Barron</a></h4>
						<p>Chief Executive</p>
						<div class="social-icon d-flex align-items-center justify-content-center">
							<a href="#0" aria-label="Discord"><i class="fa-brands fa-discord"></i></a>
							<a href="#0" aria-label="LinkedIn"><i class="fa-brands fa-linkedin-in"></i></a>
			...
			<div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
				<div class="team-card-items">
					...
					<div class="team-content text-center">
						<h4><a href="/team">Shikhon Islam</a></h4>
						<p>Project Manager</p>
						<div class="social-icon d-flex align-items-center justify-content-center">
							<a href="#0" aria-label="Discord"><i class="fa-brands fa-discord"></i></a>
							<a href="#0" aria-label="LinkedIn"><i class="fa-brands fa-linkedin-in"></i></a>
			...
			<div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
				<div class="team-card-items">
					...
					<div class="team-content text-center">
						<h4><a href="/team">Ritu Islam</a></h4>
						<p>Chief Engineer</p>
						<div class="social-icon d-flex align-items-center justify-content-center">
							<a href="#0" aria-label="Discord"><i class="fa-brands fa-discord"></i></a>
							<a href="#0" aria-label="LinkedIn"><i class="fa-brands fa-linkedin-in"></i></a>
